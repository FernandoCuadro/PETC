<div class="modal" id="modalUpdateEvento"  tabindex="-1" role="dialog">
  ...
  <form name="formEventoUpdate" id="formEventoUpdate" action="<?php echo $_SERVER['PHP_SELF'] ?>" class="form-horizontal" method="POST">
    ...
    <div class="col-md-12 activado">
     ...
     <div class="modal-footer">
        <button type="submit" name="editar" class="btn btn-success">Guardar Cambios de mi Evento</button>
