...
<body>
	...
	<header>
  	...
  	<main>
  		...
  		<!-- <div id="bienvenidos">
  			<img src="img/bienvenidos2.png">
  		</div> -->

  		<section id="institucion-intro">

  			<!-- <h2>Conocé todo sobre el PETC</h2> -->
  			<video src="img/petc-video.mp4" autoplay preload controls muted loop></video>
