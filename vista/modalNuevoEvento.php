<div class="modal" id="exampleModal"  tabindex="-1" role="dialog">
  ...
  <form name="formEvento" id="formEvento" action="<?php echo $_SERVER['PHP_SELF'] ?>" class="form-horizontal" method="POST">
  ...
  <label for="indigo" class="circu" style="background-color: #9c27b0;"> </label>
	   ...
	   <div class="modal-footer">
      	<button type="submit" name="agregar" class="btn btn-success">Guardar Evento</button>
